...
! Study in which 1000 people were texted at random times throughout the day (Killingsworth & Gilbert, 2010)
...
mind is only the first step in mindfulness practice
...
![](/docs/cogsci-c100/intro/brain-methods.png)
...
it's doing, relaxing, breathing. (Adapted from MARC UCLA guided meditations)
...
feel as you continue to engage in the old habit and in particular, how you feel
...
that would be on a subsequent 10-item antonyms test for as long as they wanted
...
- Asked what Zen training leads to, a Western student in Japan answered, _“No paranormal experiences that I can detect. But you wake up in the morning and the world seems so beautiful you can hardly stand it.”_
...
- Main practice:
    ...
    1. Now let that feeling arise again in your heart and infuse you with gratitude.
    ...
    1. Let your heart open now, and let love flow from it; then extend this love to
...
- Study on compassion meditation in long-term Tibetan meditation
...
objects and navigating a water maze to find a hidden platform
! Study 2:
...
{{< columns >}}<!-- mathjax fix -->
![](/docs/cogsci-c100/mindfulness/mouse1.png)
<---><!-- mathjax fix -->
![](/docs/cogsci-c100/mindfulness/mouse2.png)
{{< /columns >}}
...
- Longer-term follow-up study on mice with more advanced Alzheimer’s disease
    ...
    ![](/docs/cogsci-c100/mindfulness/mouse3.png)
- Results:
{{< columns >}}<!-- mathjax fix -->
...
![](/docs/cogsci-c100/mindfulness/monks.png)
...
{{< figure  src="/docs/cogsci-c100/mindfulness/antibody.png" >}}
...
# Psychological/Neurological effects of mindfulness
...
![](/docs/cogsci-c100/mindfulness/cortical.png)
...
much the same way that physical exercise increases the size of muscles (Luders, Toga, Lepore et al., 2009)
...
compared with controls (Biegal, Brown, Shapiro, & Schubert, 2009)
...
of meditation only in long-term practitioners (Lutz, Greischar, & Rawlings, 2004)
...
- __In general, there are more similarities than differences between psychological
effects of different types of meditation__

## Gene expression

! Just one day (8 hours) of intensive practice of mindfulness
meditation resulted in significant modulation of expression of proinflammatory genes (Kaliman, Alvarez-Lopez, Cosin-Tomas et al., 2014)
