...
- Creates an internal (though external of possible, just uncommon) thread
{{< figure  src="/docs/e-29/1/tap.png" >}}

## Punching

- Creates an edge using shear forces -- think industrial hole punch 
    - There has to be a gap between the punch and die; around 6-10% of the desired hole size
...
### Laser cutting
- In laser cutting, an intense beam of light imparts heat locally to the material and converts the solid either to liquid or directly to vapor to form an edge. In ablation, a laser beam vaporizes material from the surface of a component to shape it without cutting all the way through it.
...
![](/docs/e-29/1/edm.png)
- An electrical field is applied between a high-melting-point electrode and the material that is to be shaped, usually submerged in water. 
...
- A high-pressure (≫ 100 MPa) jet of water containing fine, hard 
particles (usually garnet) impact a sheet of material and cut through it. 
