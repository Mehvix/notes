...
### Using chip thickness to estimate .$\phi$

{{< figure  src="/docs/e-29/1/phi.png" >}}
<!-- - Can then use the relationship between .$\phi$ and .$\gamma$ from previous slide to estimate .$\gamma$ Merchant’s shear angle relationship -->
