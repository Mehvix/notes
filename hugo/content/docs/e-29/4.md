...
- When a high degree of material heterogeneity is needed in a single object (e.g. in color, or mechanical stiffness) it may be necessary to turn to high-end 3D inkjet printing processes.
