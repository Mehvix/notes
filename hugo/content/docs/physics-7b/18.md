...
$$\overline{K} = \frac{3}{2}k_B T \Longrightarrow \frac{1}{2}m\bar{v}^2 = \frac{3}{2}k_B T \Longrightarrow v_{\text{rms}} = \sqrt{\bar{v}^2} = \sqrt{3k_B\frac{T}{m}} = \sqrt{3 R\frac{T}{M}} $$
