...
- In a system with .$N$ molecules each of mass .$m$ and average speed .$\bar{v}^2$, we can combine the ideal gas law with the .$\overline{KE}$ equation:
...
- And since the system's internal energy .$E_{\text{int}} = N \cdot \overline{K}$ then we can write an important .$PV$ relation + find the gass .$E_{\text{int}}$:
$$T = \frac{m\bar{v}^2}{3k_B} = \frac{2}{3} \cdot \frac{E_{\text{int}}}{N k_B} \Longrightarrow PV = \frac{2}{3}E_{\text{int}}$$
...
$$\overline{K} = \frac{3}{2}k_B T \Longrightarrow \frac{1}{2}m\bar{v}^2 = \frac{3}{2}k_B T \Longrightarrow v\_{rms} = \sqrt{\bar{v}^2} = \sqrt{\frac{3k_B T}{m}} $$
...
$$v_p = 1.41 \sqrt{\frac{k_B T}{m}}$$
$$v_{\text{avg}} = 1.60 \sqrt{\frac{k_B T}{m}}$$
$$v_{\text{rms}} = \sqrt{3} \sqrt{\frac{k_B T}{m}}$$
